...
public class ArtifactVersionsTest {
	...
	public void test4DigitVersions() throws Exception {
		...
		final DefaultArtifact artifact = new DefaultArtifact("group", "artifact",
				VersionRange.createFromVersionSpec("[1.0,3.0]"), "foo", "bar", "jar", new DefaultArtifactHandler());
		// TODO This should also work for the MavenVersionComparator when using maven
		// 3.x libraries
		ArtifactVersions instance = new ArtifactVersions(artifact, Arrays.asList(versions),
		...
		assertThat(instance.getVersions(),
				Matchers.arrayContaining(versions("1.0.0.1", "1.0.0.2", "1.1.1", "2.100.0.1", "2.121.2.1", "3.1.0.1")));
		...
		assertThat(instance.getVersions(new DefaultArtifactVersion("1.0.0.2"), null),
				// Matchers.arrayContaining(versions("1.1.1", "2.121.2.1", "2.100.0.1",
				// "3.1.0.1")));
				Matchers.arrayContaining(versions("1.1.1", "2.100.0.1", "2.121.2.1", "3.1.0.1")));
