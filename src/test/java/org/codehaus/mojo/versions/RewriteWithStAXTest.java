...
public class RewriteWithStAXTest {
	...
	public void testReplace() throws Exception {
		...
		String expected = "<?xml version='1.0' encoding='utf-8'?>\n" + "<project>\n\r\n\r\n\r\n\r" + "  <parent>\r\n"
				+ "    <groupId xmlns='foo'>org.codehaus.mojo</groupId>\n"
				+ "    <artifactId>my-artifact</artifactId>\n" + "    <version>5-SNAPSHOT</version>\r" + "  </parent>\r"
				+ "<build/></project>";
		...
		while (eventReader.hasNext()) {
			...
			if (event instanceof StartElement && event.asStartElement().getName().getLocalPart().equals("artifactId")) {
				eventReader.mark(0);
			}
	...
	public void testReplaceFancy() throws Exception {
		String input = "<project xmlns=\"http://maven.apache.org/POM/4.0.0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd\">\n"
				...
				+ "    </plugins>\n" + "  </build>\n" + "\n" + "</project>";
		String expected = "<project xmlns=\"http://maven.apache.org/POM/4.0.0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd\">\n"
				+ "  <modelVersion>4.0.0</modelVersion>\n" + "\n" + "  <parent>\n"
				+ "    <groupId>org.codehaus.mojo</groupId>\n" + "    <artifactId>mojo-sandbox-parent</artifactId>\n"
				+ "    <version>4</version>\n" + "  </parent>\n" + "\n" + "  <groupId>org.codehaus.mojo</groupId>\n"
				+ "  <artifactId>versions-maven-plugin</artifactId>\n" + "  <version>1.0.0-alpha-1-SNAPSHOT</version>\n"
