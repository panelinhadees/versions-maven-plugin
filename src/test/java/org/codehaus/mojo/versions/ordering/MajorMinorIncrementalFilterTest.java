...
public class MajorMinorIncrementalFilterTest {
	...
	private ArtifactVersion[] newerVersions = new ArtifactVersion[] { version("1.1.1-sp1"), version("1.1.1-1"),
			version("1.1.2"), version("1.1.3"), version("1.2.0"), version("2.0.0-SNAPSHOT") };
	...
	public void checkFilter() {
		...
		assertThat(filteredVersions, arrayContaining(version("1.1.1-sp1"), version("1.1.1-1"), version("1.1.2"),
				version("1.1.3"), version("1.2.0"), version("2.0.0-SNAPSHOT")));
	}
	...
	public void checkFilterWithNoMajorOrMinorUpdates() {
		...
		assertThat(filteredVersions,
				arrayContaining(version("1.1.1-sp1"), version("1.1.1-1"), version("1.1.2"), version("1.1.3")));
	}
	...
	public void checkFilterWithSnapshotAtSameVersion() {
		...
		MajorMinorIncrementalFilter filter = new MajorMinorIncrementalFilter(false, false, false);
		ArtifactVersion[] filteredVersions = filter.filter(selectedVersion, new ArtifactVersion[] { version("1.1.1") });
	...
	public void checkFilterWithNonStandardVersions() {
		...
		ArtifactVersion[] newerVersions = new ArtifactVersion[] { version("1.1.1.1-sp1"), version("1.1.1.2"),
				version("1.1.2.21"), version("1.1.3.0"), version("1.2.0"), version("1.2.0.1"),
				version("2.0.0-SNAPSHOT") };

		ArtifactVersion[] filteredVersions = filter.filter(selectedVersion, newerVersions);
		assertThat(filteredVersions, arrayContaining(version("1.1.1.1-sp1"), version("1.1.1.2"), version("1.1.2.21"),
				version("1.1.3.0"), version("1.2.0"), version("1.2.0.1"), version("2.0.0-SNAPSHOT")));
	}
