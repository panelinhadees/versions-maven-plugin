...
public abstract class AbstractVersionsUpdaterMojo extends AbstractMojo {
	 ...
	 * version numbers. The URI could be either a Wagon URI or a classpath URI (e.g.
	 * <code>classpath:///package/sub/package/rules.xml</code>).
	 *
	 * @since 1.0-alpha-3
	 */
	...
	public VersionsHelper getHelper() throws MojoExecutionException {
		if (helper == null) {
			helper = new DefaultVersionsHelper(artifactFactory, artifactResolver, artifactMetadataSource,
					remoteArtifactRepositories, remotePluginRepositories, localRepository, wagonManager, settings,
					serverId, rulesUri, getLog(), session, pathTranslator);
		}
		return helper;
	}
	 ...
	 *         specified version range or <code>null</code> if no matching version
	 *         could be found.
	 * @throws ArtifactMetadataRetrievalException If the artifact metadata could not
	 *                                            be found.
	 * @since 1.0-alpha-1
	 */
	protected ArtifactVersion findLatestVersion(Artifact artifact, VersionRange versionRange, Boolean allowingSnapshots,
			boolean usePluginRepositories) throws ArtifactMetadataRetrievalException, MojoExecutionException {
	 ...
	 * point to allow updating a file external to the reactor.
	 *
	 * @param pom      The pom.
	...
	/**
	 * Processes the specified file. This is an extension point to allow updating a
	 * file external to the reactor.
	 *
	...
	/**
	 * Creates a
	 * {@link org.codehaus.mojo.versions.rewriting.ModifiedPomXMLEventReader} from a
	 * StringBuilder.
	 *
	 * @param input The XML to read and modify.
	 * @return The
	 *         {@link org.codehaus.mojo.versions.rewriting.ModifiedPomXMLEventReader}.
	 */
	...
	/**
	 * Based on the passed flags, determines which segment is unchangable. This can
	 * be used when determining an upper bound for the "latest" version.
	 *
	 * @param allowMajorUpdates
	 * @param allowMinorUpdates
	 * @param allowIncrementalUpdates
	 * @return Returns the segment that is unchangable. If any segment can change,
	 *         returns -1.
	 */
	...
	protected void updatePropertyToNewestVersion(ModifiedPomXMLEventReader pom, Property property,
			PropertyVersions version, String currentVersion) throws MojoExecutionException, XMLStreamException {
