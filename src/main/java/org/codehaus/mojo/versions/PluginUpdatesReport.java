...
public class PluginUpdatesReport extends AbstractVersionsReport {
	...
	protected void doGenerateReport(Locale locale, Sink sink) throws MavenReportException {
		...
		try {
			Map<Plugin, PluginUpdatesDetails> pluginUpdates = getHelper().lookupPluginsUpdates(plugins,
					getAllowSnapshots());
			Map<Plugin, PluginUpdatesDetails> pluginManagementUpdates = getHelper()
					.lookupPluginsUpdates(pluginManagement, getAllowSnapshots());
	 ...
	 * @param pluginManagement The set of dependencies from the dependency
	 *                         management section.
