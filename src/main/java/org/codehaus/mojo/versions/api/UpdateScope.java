...
public abstract class UpdateScope implements Comparable, Serializable {
		...
		public ArtifactVersion getOldestUpdate(VersionDetails versionDetails, ArtifactVersion currentVersion,
			...
			return versionComparator.getSegmentCount(currentVersion) < 3 ? null
					: versionDetails.getOldestVersion(currentVersion,
							versionComparator.incrementSegment(currentVersion, 2), includeSnapshots, false, false);
		}
	...
	/**
	 * Incremental version updates, that is the third segment of the version number,
	 * for example <code>1.0.0.15</code> to <code>1.0.1.0</code>.
	 *
	 * @since 1.0-beta-1
	 */
	...
	/**
	 * Minor version updates, that is the second segment of the version number, for
	 * example <code>1.0.0.15</code> to <code>1.1.0.0</code>.
	 *
	 * @since 1.0-beta-1
	 */
	...
	/**
	 * Major version updates, that is the first segment of the version number, for
	 * example <code>1.0.0.15</code> to <code>2.0.0.0</code>.
	 *
	 * @since 1.0-beta-1
	 */
	...
	/**
	 * Returns the next version after the specified current version within this
	 * scope.
	 *
	 * @param versionDetails   The versions to select from.
	 * @param currentVersion   The current version.
	 * @param includeSnapshots Whether to include snapshots.
	 * @return The next version within this scope or <code>null</code> if there is
	 *         no version within this scope.
	 * @throws ArtifactMetadataRetrievalException if there was a problem retrieving
	...
	/**
	 * Returns the newest version after the specified current version within this
	 * scope.
	 *
	 * @param versionDetails   The versions to select from.
	 * @param currentVersion   The current version.
	 * @param includeSnapshots Whether to include snapshots.
	 * @return The newest version within this scope or <code>null</code> if there is
	 *         no version within this scope.
	 */
	...
	/**
	 * Returns all versions newer than the specified current version within this
	 * scope.
	 *
	 * @param versionDetails   The versions to select from.
	 * @param currentVersion   The current version.
	...
	/**
	 * The name of this constant, as declared in the declaration. Most programmers
	 * should use the {@link #toString} method rather than accessing this field.
	 */
	...
	/**
	 * Throws CloneNotSupportedException. This guarantees that levels are never
	 ...
	 * @throws NullPointerException     if <tt>enumType</tt> or <tt>name</tt> is
	 *                                  null
	 */
	...
	public static UpdateScope classifyUpdate(VersionComparator comparator, ArtifactVersion from, ArtifactVersion to) {
		...
		// the trick here is that incrementing from twice and to once, should give the
		// same version
		int matchSegment = 0;
		for (int segment = Math.min(comparator.getSegmentCount(from),
				comparator.getSegmentCount(to)); segment > 0; segment--) {
