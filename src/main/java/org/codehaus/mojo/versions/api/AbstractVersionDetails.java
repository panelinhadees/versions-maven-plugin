...
public abstract class AbstractVersionDetails implements VersionDetails {
	...
	/**
	 * Not sure if we need to be thread safe, but there's no harm being careful,
	 * after all we could be invoked from an IDE.
	 *
	 * @since 1.0-beta-1
	 */
	 ...
	 *                               that cannot be changed. For example, a value of
	 *                               0 indicates that the major version number
	 *                               cannot be changed. A value of -1 indicates any
	...
	public final ArtifactVersion getNewestVersion(VersionRange versionRange, ArtifactVersion lowerBound,
			ArtifactVersion upperBound, boolean includeSnapshots, boolean includeLower, boolean includeUpper) {
