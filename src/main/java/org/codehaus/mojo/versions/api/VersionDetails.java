...
public interface VersionDetails {
	 ...
	 *
	 * @param versionRange     The version range within which the version must
	 *                         exist.
	 * @param includeSnapshots <code>true</code> if snapshots are to be included.
	 ...
	 *
	 * @param lowerBound the lower bound or <code>null</code> if the lower limit is
	 *                   unbounded.
	 * @param upperBound the upper bound or <code>null</code> if the upper limit is
	 *                   unbounded.
	 * @return all available versions within the specified version range.
	 * @since 1.0-beta-1
	 */
	 ...
	 * Returns all available versions within the specified bounds.
	 *
	 * @param lowerBound       the lower bound or <code>null</code> if the lower
	 *                         limit is unbounded.
	 * @param upperBound       the upper bound or <code>null</code> if the upper
	 *                         limit is unbounded.
	 * @param includeSnapshots <code>true</code> if snapshots are to be included.
	 * @return all available versions within the specified version range.
	 * @since 1.0-beta-1
	 ...
	 *                         where <code>null</code> imples <code>[,)</code>.
	 * @param lowerBound       the lower bound or <code>null</code> if the lower
	 *                         limit is unbounded.
	 * @param upperBound       the upper bound or <code>null</code> if the upper
	 *                         limit is unbounded.
	...
	/**
	 * Returns the latest version newer than the specified lowerBound, but less than
	 * the specified upper bound or <code>null</code> if no such version exists.
	 *
	 * @param lowerBound the lower bound or <code>null</code> if the lower limit is
	 *                   unbounded.
	 * @param upperBound the upper bound or <code>null</code> if the upper limit is
	 *                   unbounded.
	 * @return the latest version between lowerBound and upperBound or
	 *         <code>null</code> if no version is available.
	 * @since 1.0-alpha-3
	 */
	 ...
	 *                         limit is unbounded.
	 * @param includeSnapshots <code>true</code> if snapshots are to be included.
	 * @return the latest version between currentVersion and upperBound or
	 *         <code>null</code> if no version is available.
	 * @since 1.0-alpha-3
	 */
	...
	/**
	 * Returns the latest version newer than the specified current version, but less
	 * than the specified upper bound or <code>null</code> if no such version
	 * exists.
	 *
	 * @param lowerBound       the lower bound or <code>null</code> if the lower
	 *                         limit is unbounded.
	 ...
	 * @param includeLower     <code>true</code> if the lower bound is inclusive.
	 * @param includeUpper     <code>true> if the upper bound is inclusive.
	 * &#64;return the latest version between lowerBound and upperBound or <code>null</code>
	 ...
	 *                         exist.
	 * @param includeSnapshots <code>true</code> if snapshots are to be included.
	 * @return the latest version within the version range or <code>null</code> if
	...
	/**
	 * Returns the oldest version after the specified lowerBound, but less than the
	 * specified upper bound or <code>null</code> if no such version exists.
	 *
	 * @param lowerBound the lower bound or <code>null</code> if the lower limit is
	 *                   unbounded.
	 * @param upperBound the upper bound or <code>null</code> if the upper limit is
	 *                   unbounded.
	 * @return the next version between lowerBound and upperBound or
	 *         <code>null</code> if no version is available.
	 * @since 1.0-beta-1
	 */
	 ...
	 *                         exist.
	 * @param includeSnapshots <code>true</code> if snapshots are to be included.
	 * @return the oldest version between currentVersion and upperBound or
	 *         <code>null</code> if no version is available.
	 * @since 1.0-beta-1
	 */
	...
	/**
	 * Returns the oldest version newer than the specified lower bound, but less
	 * than the specified upper bound or <code>null</code> if no such version
	 * exists.
	 *
	 * @param lowerBound       the lower bound or <code>null</code> if the lower
	...
	/**
	 * Returns the oldest version within the specified bounds or <code>null</code>
	 ...
	 * @param includeLower     <code>true</code> if the lower bound is inclusive.
	 * @param includeUpper     <code>true> if the upper bound is inclusive.
	 * &#64;return the oldest version between lowerBound and upperBound or <code>null</code>
	 *                         if no version is available.
	 * @since 1.0-beta-1
	 */
	ArtifactVersion getOldestVersion(ArtifactVersion lowerBound, ArtifactVersion upperBound, boolean includeSnapshots,
	...
	/**
	 * Returns the oldest version newer than the specified current version, but
	 * within the the specified update scope or <code>null</code> if no such version
	 * exists.
	 *
	 * @param currentVersion the lower bound or <code>null</code> if the lower limit
	 *                       is unbounded.
	 * @param updateScope    the update scope to include.
	 * @return the oldest version after currentVersion within the specified update
	 *         scope or <code>null</code> if no version is available.
	 * @since 1.0-beta-1
	 */
	ArtifactVersion getOldestUpdate(ArtifactVersion currentVersion, UpdateScope updateScope);

	/**
	 * Returns the newest version newer than the specified current version, but
	 * within the the specified update scope or <code>null</code> if no such version
	 * exists.
	 *
	 * @param currentVersion the lower bound or <code>null</code> if the lower limit
	 *                       is unbounded.
	 * @param updateScope    the update scope to include.
	 * @return the newest version after currentVersion within the specified update
	 *         scope or <code>null</code> if no version is available.
	 * @since 1.0-beta-1
	 */
	 ...
	 *                       is unbounded.
	 * @param updateScope    the update scope to include.
	 * @return the all versions after currentVersion within the specified update
	 *         scope.
	 * @since 1.0-beta-1
	 */
	 ...
	 * exists.
	 *
	 * @param currentVersion   the lower bound or <code>null</code> if the lower
	 *                         limit is unbounded.
	 * @param updateScope      the update scope to include.
	 * @param includeSnapshots <code>true</code> if snapshots are to be included.
	 * @return the oldest version after currentVersion within the specified update
	 ...
	 * <code>getCurrentVersion() != null</code>.
	 *
	...
	/**
	 * Returns the oldest version newer than the current version, but within the the
	 * specified update scope or <code>null</code> if no such version exists.
	 *
	 * @param updateScope the update scope to include.
	 * @return the oldest version after currentVersion within the specified update
	 *         scope or <code>null</code> if no version is available.
