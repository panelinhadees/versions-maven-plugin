...
/**
 * Helper class that provides common functionality required by both the mojos
 * and the reports.
 *
...
public interface VersionsHelper {
	...
	/**
	 * Returns the version comparator to use for the specified groupId and
	 * artifactId.
	 *
	 ...
	 * <code>getArtifactFactory().createPluginArtifact(...)</code>.
	 *
	...
	/**
	 * Shorthand method for
	 * <code>getArtifactFactory().createDependencyArtifact(...)</code>.
	 *
	 * @param groupId    The group id.
	 * @param artifactId The artifact id.
	...
	/**
	 * Shorthand method for
	 * <code>getArtifactFactory().createDependencyArtifact(...)</code> which
	 * extracts the parameters from the Dependency instance.
	 *
	 * @param dependency The dependency to create the artifact for.
	 * @return The corresponding dependency artifact.
	 * @throws InvalidVersionSpecificationException if the version specified in the
	...
	/**
	 * Takes a {@link List} of {@link org.apache.maven.project.MavenProject}
	 * instances and converts it into a {@link Set} of {@link Artifact} instances.
	 *
	 * @param mavenProjects the {@link List} of
	 *                      {@link org.apache.maven.project.MavenProject} instances.
	...
	/**
	 * Looks up the versions of the specified artifact that are available in either
	 * the local repository, or the appropriate remote repositories.
	 *
	 * @param artifact              The artifact to look for versions of.
	 * @param usePluginRepositories <code>true</code> will consult the
	 *                              pluginRepositories, while <code>false</code>
	 *                              will consult the repositories for normal
	 *                              dependencies.
	 ...
	 *
	 * @param dependencies          The set of {@link Dependency} instances to look
	 *                              up.
	 * @param usePluginRepositories Search the plugin repositories.
	 * @return A map, keyed by dependency, with values of type
	 *         {@link org.codehaus.mojo.versions.api.ArtifactVersions}.
	 * @throws ArtifactMetadataRetrievalException When things go wrong.
	 * @since 1.0-beta-1
	 */
	...
	/**
	 * Creates an {@link org.codehaus.mojo.versions.api.ArtifactVersions} instance
	 * from a dependency.
	 *
	 ...
	 * @param allowSnapshots Include snapshots in the list of updates.
	 * @return A map, keyed by plugin, with values of type
	 *         {@link org.codehaus.mojo.versions.PluginUpdatesDetails}.
	 * @throws ArtifactMetadataRetrievalException When things go wrong.
	 * @since 1.0-beta-1
	 */
	...
	/**
	 * Returns a map of {@link org.codehaus.mojo.versions.api.PropertyVersions}
	 * values keyed by {@link org.codehaus.mojo.versions.Property} instances
	 * consisting of the properties defined in the project which are associated with
	 * version information.
	 *
	 * @param project             The project.
	 ...
	 * @return a map of {@link org.codehaus.mojo.versions.api.PropertyVersions}
	 *         values keyed by {@link org.codehaus.mojo.versions.Property}
	 *         instances.
	 * @throws MojoExecutionException if something goes wrong.
	 */
	Map<Property, PropertyVersions> getVersionPropertiesMap(MavenProject project, Property[] propertyDefinitions,
			String includeProperties, String excludeProperties, boolean autoLinkItems) throws MojoExecutionException;

	/**
	 * Attempts to resolve the artifact.
	 *
	 * @param artifact              The artifact to resolve.
	 * @param usePluginRepositories whether to resolve from the plugin repositories
	 *                              or the regular repositories.
	 * @since 1.3
	 */
