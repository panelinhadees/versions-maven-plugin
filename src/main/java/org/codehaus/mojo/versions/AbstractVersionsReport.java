...
public abstract class AbstractVersionsReport extends AbstractMavenReport {
	 ...
	 * <code>maven</code>, <code>numeric</code> which will handle long version
	 * numbers provided all components are numeric, or <code>mercury</code> which
	 * will use the mercury version number comparison rules.
	 *
	 * @since 1.0-alpha-1
	 */
	...
	protected ArtifactVersion findLatestVersion(Artifact artifact, VersionRange versionRange, boolean allowingSnapshots,
			boolean usePluginRepositories) throws MavenReportException {
