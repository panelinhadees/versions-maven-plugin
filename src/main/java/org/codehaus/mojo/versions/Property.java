...
public class Property {
	...
	/**
	 * Dependencies that must be available for this property. If
	 * {@link #autoLinkDependencies} is true then these dependencies will be
	 * considered in addition to the automatically linked dependencies.
	 *
	 * @parameter
	 * @since 1.0-alpha-3
	 */
	...
	/**
	 * When {@link #searchReactor} is <code>true</code> and a property version can
	 * be entirely satisfied from the reactor and this setting is <code>true</code>
	 * then the reactor version will be specified irrespective of any other settings
	...
	/**
	 * Whether the snapshot versions cannot be used as an artifact versions (unless
	 * {@link #preferReactor} applies).
	 *
