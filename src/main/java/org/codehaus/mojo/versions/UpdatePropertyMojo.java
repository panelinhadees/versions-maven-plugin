...
public class UpdatePropertyMojo extends AbstractVersionsUpdaterMojo {
	 ...
	 * version within).
	 * <ul>
	 * <li><code>1.0</code>x >= 1.0. The default Maven meaning for 1.0 is everything
	 * (,) but with 1.0 recommended.</li>
	 ...
	 * higher</li>
	 * </ul>
	 * If you like to define the version to be used exactly you have to use it like
	 * this: <code>-DnewVersion=[19.0]</code> otherwise a newer existing version
	 * will be used. If you need to downgrade a version you have to define
	 * <code>-DallowDowngrade=true</code> as well otherwise the version will be
	 * kept.
	 * 
	 * @since 1.3
	 */
	...
	/**
	 * If a property points to a version like <code>1.2.3</code> and your repository
	 * contains versions like <code>1.2.3</code> and <code>1.1.0</code> without
	 * settings this to <code>true</code> the property will never being changed back
	 * to <code>1.1.0</code> by using <code>-DnewVersion=[1.1.0]</code>.
	 * 
	 * @since 3.0.0
	 */
