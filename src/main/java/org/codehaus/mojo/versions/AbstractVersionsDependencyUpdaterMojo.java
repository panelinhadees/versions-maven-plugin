...
public abstract class AbstractVersionsDependencyUpdaterMojo extends AbstractVersionsUpdaterMojo {
	 ...
	 * set of includes from the command line. When specifying includes from the pom,
	 * use the {@link #includes} configuration instead. If this property is
	 ...
	 * "groupId:artifactId:type:classifier:version". Designed to allow specifing the
	 * set of excludes from the command line. When specifying excludes from the pom,
	 * use the {@link #excludes} configuration instead. If this property is
	 ...
	 * "groupId:artifactId:type:classifier:version". This configuration setting is
	 * ignored if {@link #includesList} is defined.
	 *
	 * @since 1.0-beta-1
	 */
	@Parameter
	 ...
	 * "groupId:artifactId:type:classifier:version". This configuration setting is
	 * ignored if {@link #excludesList} is defined.
	 *
	 * @since 1.0-beta-1
	 */
	@Parameter
	...
	/**
	 * Whether to process the parent section of the project. If not set will default
	 * to false.
	 *
	 * @since 2.3
	 */
	 ...
	 *
	 * @return returns <code>true if the project/dependencies section of the pom
	 *         should be processed.
	 * @since 1.0-alpha-3
	 */
	 ...
	 *
	 * @return returns <code>true if the project/dependencyManagement section of the
	 *         pom should be processed.
	 * @since 1.0-alpha-3
	 */
	 ...
	 *
	 * @return returns <code>true if the project/parent section of the pom should be
	 *         processed.
	 * @since 2.3
	 */
	 ...
	 * processing.
	 *
	 * @return returns <code>true if the artifacts produced in the current reactor
	...
	/**
	 * Returns <code>true</code> if the dependency is produced by the current
	 * reactor.
	 *
	 * @param dependency the dependency to heck.
	 * @return <code>true</code> if the dependency is produced by the current
	 *         reactor.
	 * @since 1.0-alpha-3
	 */
	...
	/**
	 * Compare a project to a dependency. Returns true only if the groupId and
	 * artifactId are all equal.
	 *
	...
	/**
	 * Compare and artifact to a dependency. Returns true only if the groupId,
	 * artifactId, type, and classifier are all equal.
	 *
	 * @param artifact
	 * @param dep
	...
	/**
	 * Determine if the artifact is included in the list of artifacts to be
	 * processed.
	 *
	...
	/**
	 * Indicates whether any includes were specified via the 'includes' or
	 * 'includesList' options.
	 * 
	...
	/**
	 * To handle multiple includes with version range like
	 * "group:artifact:jar:[1.0.0,2.2)", we have to use a parsing a little bit more
	 * complex than split().
	 *
