...
/**
 * Represents the modified pom file. Note: implementations of the StAX API
 * (JSR-173) are not good round-trip rewriting <b>while</b> keeping all
 * unchanged bytes in the file as is. For example, the StAX API specifies that
 * <code>CR</code> characters will be stripped. Current implementations do not
 * keep &quot; and &apos; characters consistent.
 *
...
public class ModifiedPomXMLEventReader implements XMLEventReader {
	...
	/**
	 * Constructor ModifiedPomXMLEventReader creates a new ModifiedPomXMLEventReader
	 * instance.
	 *
	...
	/**
	 * Returns <code>true</code> if nextEnd is including the start of and end
	 * element.
	 *
	 * @return <code>true</code> if nextEnd is including the start of and end
	 *         element.
	 */
	...
	/**
	 * Returns <code>true</code> if nextEnd is including the start of the next
	 * event.
	 *
	 * @return <code>true</code> if nextEnd is including the start of the next
	 *         event.
	 */
	...
	/**
	 * Replaces all content between marks index1 and index2 with the replacement
	 * text.
	 *
