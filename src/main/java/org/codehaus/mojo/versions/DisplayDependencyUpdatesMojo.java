...
public class DisplayDependencyUpdatesMojo extends AbstractVersionsDisplayMojo {
	...
	/**
	 * Whether to process the dependencies sections of plugins which are defined in
	 * pluginManagement.
	 *
	 * @since 2.5
	 */
	...
	/**
	 * Whether to allow the major version number to be changed. You need to set
	 * {@link #allowAnyUpdates} to <code>false</code> to get this configuration gets
	 * control.
	 * 
	 * @since 2.5
	 */
	...
	/**
	 * Whether to allow the minor version number to be changed. You need to set
	 * {@link #allowMajorUpdates} to <code>false</code> to get this configuration
	 * gets control.
	 *
	 * @since 2.5
	 */
	...
	/**
	 * Whether to allow the incremental version number to be changed. You need to
	 * set {@link #allowMinorUpdates} to <code>false</code> to get this
	 * configuration gets control.
	 *
	 * @since 2.5
	 */
	...
	/**
	 * Whether to allow any version change to be allowed. This keeps compatibility
	 * with previous versions of the plugin. If you set this to false you can
	 * control changes in version number by {@link #allowMajorUpdates},
	...
	/**
	 * Whether to show additional information such as dependencies that do not need
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
				...
				if (dependency.getVersion() == null) {
					...
					if (getProject().hasParent()) {
						...
						if (getProject().getParent().getDependencyManagement() != null) {
							List<Dependency> parentDeps = getProject().getParent().getDependencyManagement()
									.getDependencies();
		...
		if (isProcessPluginDependenciesInDependencyManagement()) {
			pluginDependenciesInPluginManagement = extractPluginDependenciesFromPluginsInPluginManagement(
					getProject().getBuild());
		}
