...
public final class WagonUtils {
	...
	/**
	 * Convenience method to convert the {@link org.apache.maven.settings.Proxy}
	 * object from a {@link org.apache.maven.settings.Settings} into a
	 * {@link org.apache.maven.wagon.proxy.ProxyInfo}.
	 *
	 * @param settings The settings to use.
	 * @return The proxy details from the settings or <code>null</code> if the
	 *         settings do not define a proxy.
	 */
	 ...
	 * @throws org.apache.maven.wagon.UnsupportedProtocolException           if the
	 *                                                                       protocol
	 *                                                                       is not
	 *                                                                       supported.
	 * @throws org.apache.maven.artifact.manager.WagonConfigurationException if the
	 *                                                                       wagon
	 *                                                                       cannot
	 *                                                                       be
	 *                                                                       configured.
	 * @throws org.apache.maven.wagon.ConnectionException                    If the
	 *                                                                       connection
	 *                                                                       cannot
	 *                                                                       be
	 *                                                                       established.
	 * @throws org.apache.maven.wagon.authentication.AuthenticationException If the
	 *                                                                       connection
	 *                                                                       cannot
	 *                                                                       be
	 *                                                                       authenticated.
